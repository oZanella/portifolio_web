...
export function Hero() {
  return (
    <section className="pt-10">
      <Container className="grid gap-12 md:grid-cols-[1.15fr_0.85fr] md:items-stretch">
        <div className="flex h-full flex-col gap-6">
          <div className="space-y-4">
            ...
            <p className="max-w-xl text-base text-tone-secondary md:text-lg">
              {profile.summary}
            </p>
          </div>
        ...
        <div className="flex h-full flex-col gap-6">
          ...
          <div className="mt-auto rounded-3xl border surface-strong bg-section-fade p-6">
            <p className="text-xs uppercase tracking-[0.35em] text-tone-subtle">
              stack principal
            </p>
            ...
            <div className="mt-5">
              <Button tone="accent" variant="soft" size="sm">
